...
function Footer() {
  return (
    <footer className="footer">
      ...
      <span style={{ height: "18vh", color: "white" }}>

        <div style={{ width: "50%", background: "red", float: "left", textAlign: "center", fontSize: "25px", padding: "5%" }}>

          © 2021 - WJ Best Insulation LLC All Rights Reserved
        </div>

        <div style={{ width: "50%", background: "blue", float: "left", padding: "5%", textAlign: "center" }}>
